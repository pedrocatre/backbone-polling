 ...
 */
define(['backbone', 'underscore', 'handlebars', 'masterView', 'text!../app/modules/dataMonitor/process/processList.html', 'processItemView', 'backbone'],
    function (Backbone, _, Handlebars, MasterView, ProcessListTemplate, ProcessItemView) {
        var ProcessListView = MasterView.extend({
